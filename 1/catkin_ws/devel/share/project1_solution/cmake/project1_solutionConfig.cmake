...
if("TRUE" STREQUAL "TRUE")
  set(project1_solution_SOURCE_PREFIX /home/k5200/CSMM.103x/1/catkin_ws/src/project1_solution)
  set(project1_solution_DEVEL_PREFIX /home/k5200/CSMM.103x/1/catkin_ws/devel)
  ...
  set(project1_solution_INSTALL_PREFIX /home/k5200/CSMM.103x/1/catkin_ws/install)
...
if(NOT "/home/k5200/CSMM.103x/1/catkin_ws/devel/include " STREQUAL " ")
  set(project1_solution_INCLUDE_DIRS "")
  set(_include_dirs "/home/k5200/CSMM.103x/1/catkin_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'project1_solution' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/k5200/CSMM.103x/1/catkin_ws/src/project1_solution/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT project1_solution_NUM_DUMMY_TARGETS)
      set(project1_solution_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::project1_solution::wrapped-linker-option${project1_solution_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR project1_solution_NUM_DUMMY_TARGETS "${project1_solution_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::project1_solution::wrapped-linker-option${project1_solution_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND project1_solution_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/k5200/CSMM.103x/1/catkin_ws/devel/lib;/opt/ros/melodic/lib)
